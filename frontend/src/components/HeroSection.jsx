...
export default function HeroSection() {
  return (
    <div>
      <div className="bg-customGreen pb-4 pt-40 w-screen">
        ...
        <div className="container mx-auto  w-full  ">
          <div className=" flex justify-center gap-24 md:gap-8 lg:gap-24 flex-col md:flex-row xl:px-24">
            <div>
              <div>
                <h1 className="font-sans font-bold text-3xl px-4  lg:px-0 lg:text-5xl ">
                  Upgrade Your Tech with  Our {" "}
                  <span className="2xl:whitespace-nowrap">
                    <span className="text-[#FB9678]">High-Quality</span>
                    <span className="text-[#FB9678]"> Accessories </span>
                  </span>
                </h1>
              </div>
              <div className="mt-16 md:mt-8 font-sans px-3 lg:px-0">
                ...
                level.  */}
                  With our <br /> user-friendly interface and seamless checkout
                  process, shopping for tech has <br />
                  never been easier.
                </p>
              </div>
